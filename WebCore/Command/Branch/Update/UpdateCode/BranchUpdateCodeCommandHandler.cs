...
namespace WebCore.Command
{
    public class BranchUpdateCodeCommandHandler : ICommandHandler<BranchUpdateCodeCommand>
    {
        ...
        public BranchUpdateCodeCommandHandler(IActivityService _iActivityServices)
        {
        ...
        public void Handle(BranchUpdateCodeCommand command)
        {
            using (var uow = new UnitOfWork<EF>())
            {
                try
                {
                    ...
                    var previousVal = branchEntity.BranchCode;
                    branchEntity.LastModifiedDate = System.DateTime.Now;
                    branchEntity.BranchCode = command.BranchCode;
                    ...
                    var activity = new Activity()
                    {
                        ...
                        Current_value = command.BranchCode,
